...
function Config:CopyText(text)
    if not self.dialogName then
        --- @private
        self.dialogName = '__NUMY_CONFIG_ADDON_PLACEHOLDER__CopyTextDialog';
...
do
    ...
    function Config:MakeHeader(text, tooltip, indent)
        ...
        local headerInitializer = Settings.CreateElementInitializer("__NUMY_CONFIG_ADDON_PLACEHOLDER___SettingsHeaderTemplate", data);
    ...
    function Config:MakeText(text, indent)
        ...
        --- @type SettingsListElementInitializer
        local textInitializer = Settings.CreateElementInitializer("__NUMY_CONFIG_ADDON_PLACEHOLDER___SettingsTextTemplate", data);
    ...
    function Config:MakeSoundSelector(label, settingKey, tooltip, options, playSoundCallback, defaultValue, dbTableOverride)
        ...
        local initializer = Settings.CreateSettingInitializer('__NUMY_CONFIG_ADDON_PLACEHOLDER___SettingsSoundSelectorTemplate', data);
    ...
    function Config:MakeButton(label, onClick, tooltip)
        ...
        local initializer = Settings.CreateSettingInitializer('__NUMY_CONFIG_ADDON_PLACEHOLDER___SettingsButtonControlTemplate', data);
        initializer:AddSearchTags(label);
        self.layout:AddInitializer(initializer);
    ...
    function Config:MakeMultiButton(label, onClick, tooltip, buttonTexts)
        ...
        local initializer = Settings.CreateSettingInitializer('__NUMY_CONFIG_ADDON_PLACEHOLDER___SettingsMultiButtonControlTemplate', data);
        initializer:AddSearchTags(label);
        self.layout:AddInitializer(initializer);
    ...
    function Config:MakeInput(label, settingKey, tooltip, defaultValue, dbTableOverride)
        ...
        local initializer = Settings.CreateSettingInitializer('__NUMY_CONFIG_ADDON_PLACEHOLDER___SettingsInputControlTemplate', data);
        self.layout:AddInitializer(initializer);
    ...
    function Config:MakeColorPicker(label, settingKey, tooltip, defaultValue, dbTableOverride)
        ...
        local initializer = Settings.CreateSettingInitializer('__NUMY_CONFIG_ADDON_PLACEHOLDER___SettingsColorControlTemplate', data);
        self.layout:AddInitializer(initializer);
    ...
    __NUMY_CONFIG_ADDON_PLACEHOLDER___SettingsColorControlMixin = CreateFromMixins(SettingsControlMixin);
    do
        --- @class NumyConfig_ColorControlMixin
        local mixin = __NUMY_CONFIG_ADDON_PLACEHOLDER___SettingsColorControlMixin;
    ...
    __NUMY_CONFIG_ADDON_PLACEHOLDER___SettingsInputControlMixin = CreateFromMixins(SettingsControlMixin);
    do
        --- @class NumyConfig_InputControlMixin
        local mixin = __NUMY_CONFIG_ADDON_PLACEHOLDER___SettingsInputControlMixin;
    ...
    __NUMY_CONFIG_ADDON_PLACEHOLDER___SettingsButtonControlMixin = CreateFromMixins(SettingsListElementMixin);
    do
        --- @class NumyConfig_ButtonControlMixin
        local mixin = __NUMY_CONFIG_ADDON_PLACEHOLDER___SettingsButtonControlMixin;
    ...
    __NUMY_CONFIG_ADDON_PLACEHOLDER___SettingsMultiButtonControlMixin = CreateFromMixins(SettingsListElementMixin);
    do
        --- @class NumyConfig_MultiButtonControlMixin
        local mixin = __NUMY_CONFIG_ADDON_PLACEHOLDER___SettingsMultiButtonControlMixin;
    ...
    __NUMY_CONFIG_ADDON_PLACEHOLDER___SettingsSoundSelectorMixin = CreateFromMixins(SettingsDropdownControlMixin);
    do
        --- @class NumyConfig_SoundSelectorMixin: SettingsDropdownControlMixin
        local mixin = __NUMY_CONFIG_ADDON_PLACEHOLDER___SettingsSoundSelectorMixin;
    ...
    __NUMY_CONFIG_ADDON_PLACEHOLDER___SettingsTextMixin = CreateFromMixins(DefaultTooltipMixin);
    do
        --- @class NumyConfig_TextMixin
        local mixin = __NUMY_CONFIG_ADDON_PLACEHOLDER___SettingsTextMixin;
    ...
    __NUMY_CONFIG_ADDON_PLACEHOLDER___SettingsHeaderMixin = CreateFromMixins(DefaultTooltipMixin);
    do
        --- @class NumyConfig_HeaderMixin
        local mixin = __NUMY_CONFIG_ADDON_PLACEHOLDER___SettingsHeaderMixin;
